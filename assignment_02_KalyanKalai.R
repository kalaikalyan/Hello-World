...
dir("C:/Users/kalya/Documents/Kalai/dsc520/assignments/assignment01")
...
voter_turnout_df2 <- read_excel("data/G04ResultsDetail2004-11-02.xls",col_names = c("ward_precint", "ballots_cast", "registered_voters", "voter_turnout"), skip = 2)
str(voter_turnout_df2)

## Load the `DBI` library
library(DBI)

## Create a database connection t`o data/tidynomicon/example.db` using the dbConnect() function
